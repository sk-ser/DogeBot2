...
────────────────────
ᱳ ${prefix}herolist
ᱳ ${prefix}herodetail [ hero ]
ᱳ ${prefix}google [ search ]
ᱳ ${prefix}gimage [ search ]
ᱳ ${prefix}wiki [ search ] _indo_
ᱳ ${prefix}mediafire [ link ]
ᱳ ${prefix}facebook [ fb link ]
ᱳ ${prefix}facebook2 [ fb link ]
ᱳ ${prefix}twitter [ twitter video link ]
ᱳ ${prefix}twmp3 [ twitter video link ]
ᱳ ${prefix}twitter2 [ twitter video link ]
ᱳ ${prefix}ytmp4 [ yt link ]
ᱳ ${prefix}ytmp3 [ yt link ]
ᱳ ${prefix}play [ song title ]
ᱳ ${prefix}tiktok [ link ]
ᱳ ${prefix}video [ video title ]
ᱳ ${prefix}tinyurl [ link ]
ᱳ ${prefix}fetch [ link ]
ᱳ ${prefix}instagram [insta normal video link ] 
ᱳ ${prefix}pinterest [ search ]
ᱳ ${prefix}lyrics [ title ]
ᱳ ${prefix}tourl [ reply image/video ]
ᱳ ${prefix}numbers [ number ]
ᱳ ${prefix}calculator [ number ]
ᱳ ${prefix}fancytext [text]
ᱳ ${prefix}githubstalk [ username ]
ᱳ ${prefix}translate [ code text ]
ᱳ ${prefix}ss [ link ]
────────────────────`
buttons = [
{buttonId:`sc`,buttonText:{displayText: 'ʙᴏᴛ sᴄʀɪᴘᴛ'},type:1},
